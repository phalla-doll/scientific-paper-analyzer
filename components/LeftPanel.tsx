...
import { Bot, RefreshCw, MessageSquare, Send, FileText, X, Upload, Plus, Square, Play, Download, Sun, Moon, Cpu, ArrowRight, Eye } from 'lucide-react';
    ...
    <>
                    ...
                    <div key={idx} className="flex items-center justify-between p-2 bg-white border border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800 group relative">
                        ...
                        <div className="flex items-center gap-1">
                          <button 
                            ...
                            className="p-1 text-zinc-400 hover:text-blue-500 dark:text-zinc-600 dark:hover:text-blue-400 transition-colors"
                            title="Preview PDF"
                          >
                              <Eye size={14} />
                          </button>
                          <button 
                            ...
                            className="p-1 text-zinc-400 hover:text-red-500 dark:text-zinc-600 dark:hover:text-red-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:text-zinc-400 dark:disabled:hover:text-zinc-600"
                            disabled={isAnalyzing}
                            title="Remove File"
                          >
                              <X size={14} />
      ...
      {previewFile && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="w-full h-full md:w-[90%] md:h-[90%] bg-zinc-900 border border-zinc-700 flex flex-col relative shadow-2xl">
            <CornerAccents className="border-zinc-500" />
            
            {/* Modal Header */}
            <div className="flex items-center justify-between p-4 border-b border-zinc-800 bg-zinc-900/95">
              <div className="flex items-center gap-3">
                <FileText className="text-blue-500" size={20} />
                <h3 className="text-zinc-200 font-mono text-sm truncate max-w-[200px] md:max-w-md">
                  {previewFile.name}
                </h3>
              </div>
              <button 
            ...
            <div className="flex-1 bg-zinc-950 w-full h-full relative">
              <iframe 
